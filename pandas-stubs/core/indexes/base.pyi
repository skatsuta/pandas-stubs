...
class Index(IndexOpsMixin, PandasObject, Generic[T]):
    ...
    def copy(self, name=..., deep: bool = ...) -> Index[T]: ...
    ...
    def get_level_values(self, level: int | _str) -> Index[T]: ...
    ...
    def dropna(self, how: Literal["any", "all"] = ...) -> Index[T]: ...
    def unique(self, level=...) -> Index[T]: ...
    def drop_duplicates(
